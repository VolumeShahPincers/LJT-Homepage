...
1. **SynLogic: Synthesizing Verifiable Reasoning Data at Scale for Learning Logical Reasoning and Beyond**
   ...
   - Arxiv, 2025
   - [Code](https://github.com/Vicent0205) available on GitHub
...
2. **On the Perception Bottleneck of VLMs for Chart Understanding**
   ...
   - Arxiv, 2025
   - Code: [Vision4Chart](https://github.com/Vicent0205)

**2024**
3. **On the Universal Truthfulness Hyperplane Inside LLMs**
   - Junteng Liu\*, Shiqi Chen, Yu Cheng, Junxian He
   - EMNLP 2024
   - Code: [Universal_Truthfulness_Hyperplane](https://github.com/Vicent0205)
...
- **Specialized Topics:** LLM Reasoning, Reinforcement Learning, Vision-Language Model Hallucination, LLM Truthfulness, Interpretability
